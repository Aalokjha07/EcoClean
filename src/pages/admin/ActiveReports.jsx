...
const ActiveReports = () => {
  ...
  const reports = [
    {
      id: "REP-9921",
      location: "Sector 9 - Oak Street",
      type: "Bin Overflow",
      priority: "High Priority",
      priorityClass: "bg-red-100 text-red-600",
      details:
        "Commercial waste bins are overflowing onto the sidewalk. Requires immediate clearing.",
      assignee: "Not Assigned",
      status: "Pending",
      statusClass: "text-orange-500",
      statusDot: "bg-orange-500 status-pulse",
    },
    {
      id: "REP-9918",
      location: "Sector 3 - Industrial",
      type: "Hazardous Spill",
      priority: "Medium Priority",
      priorityClass: "bg-orange-100 text-orange-600",
      details:
        "Oily substance reported near Plot 22 entry. Slip hazard for heavy machinery.",
      assignee: "Team Alpha",
      status: "Dispatching",
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 shrink-0">
          <div>
            ...
            <p className="text-purple-500 text-sm font-bold uppercase tracking-widest mt-1">
              Incoming Issues Awaiting Action
            </p>
          </div>
          <div className="relative">
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4 absolute left-4 top-3.5 text-purple-400"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
                ...
                <div className="space-y-4 mb-8">
                  ...
                  <div className="flex justify-between items-center pt-2">
                    ...
                    <div className="text-right">
                      ...
                      <p
                        className={`text-xs font-bold ${report.statusClass} flex items-center gap-1 justify-end`}
                      >
                        <span
                          className={`w-1.5 h-1.5 rounded-full ${report.statusDot}`}
                        ></span>{" "}
                        {report.status}
                      </p>
                    </div>
